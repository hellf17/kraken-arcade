...
class GameOverView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text(f"Total XP: {self.kraken_game.xp_tracker()[0]}", SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 - 50,
                         arcade.color.WHITE, font_size=25, font_name="Minecraft", anchor_x="center")
        arcade.draw_text(f"Total Time: {self.kraken_game.xp_tracker()[1]:.2f}", SCREEN_WIDTH / 2,
                         SCREEN_HEIGHT / 2 - 90,
                         arcade.color.WHITE, font_size=25, font_name="Minecraft", anchor_x="center")
...
class PauseView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Game Paused", SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2,
                         arcade.color.WHITE, font_size=70, font_name="Minecraft", anchor_x="center")
        arcade.draw_text("Press 'R' to resume", SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 - 50,
                         arcade.color.WHITE, font_size=25, font_name="Minecraft", anchor_x="center")
        arcade.draw_text("Press 'Q' to quit", SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 - 90,
                         arcade.color.WHITE, font_size=25, font_name="Minecraft", anchor_x="center")
...
class KrakenGame(arcade.View):
    ...
    def on_show(self):
        # Load and play the background music only when the view is shown
    ...
    def on_update(self, delta_time):
        ...
        # Increase enemy max count gradually
