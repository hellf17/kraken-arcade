...
class StartMenuView(arcade.View):
    ...
    def on_show(self):
        background_images = ["background1.png", "background2.png", "background3.png"]
        random_image = random.choice(background_images)
        self.menu_image = arcade.load_texture(random_image)
...
class KrakenGame(arcade.View):
    ...
    def setup(self):
        background_image = random.choice(["background1.png", "background2.png", "background3.png"])
